...
public Plano(Integer id, String nome, Double preco, String tipoPlano, LocalDate dataInicio, LocalDate dataFim, LocalDate dataVencimento, Double valorMensalidade) {
